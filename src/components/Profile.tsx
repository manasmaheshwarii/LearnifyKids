...
import { User, Mail, Calendar, Trophy, Star, Edit, Camera, Award, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage your account and track your learning journey</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 text-center transition-colors duration-300">
              ...
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2 transition-colors duration-300">{mockUser.name}</h2>
              <p className="text-purple-600 dark:text-purple-400 font-semibold mb-4 transition-colors duration-300">Level {mockUser.level} Learner</p>
              
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg transition-colors duration-300">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 transition-colors duration-300">{mockUser.points}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Points</div>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg transition-colors duration-300">
                  <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 transition-colors duration-300">{mockUser.badges.length}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Badges</div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-800 dark:text-gray-200 transition-colors duration-300">{name}</div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-800 dark:text-gray-200 transition-colors duration-300">{email}</div>
                  )}
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Account Type</label>
                  <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-800 dark:text-gray-200 capitalize transition-colors duration-300">{mockUser.type}</div>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">Member Since</label>
                  <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-800 dark:text-gray-200 transition-colors duration-300">January 2024</div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg text-center transition-colors duration-300">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 transition-colors duration-300">{mockUser.enrolledCourses.length}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Enrolled Courses</div>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg text-center transition-colors duration-300">
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400 transition-colors duration-300">{mockUser.completedCourses.length}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Completed Courses</div>
                </div>
                <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg text-center transition-colors duration-300">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 transition-colors duration-300">7</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">Day Streak</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mockUser.badges.map((badge) => (
                  <div key={badge.id} className="flex items-center space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800 transition-colors duration-300">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800 dark:text-gray-200 transition-colors duration-300">{badge.name}</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">{badge.description}</div>
