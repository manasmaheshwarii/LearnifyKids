                ...
                <div className="flex items-center space-x-4">
                  {!isCompleted ? (
                    <button
                      ...
                      disabled={loading}
                      className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-full font-semibold hover:from-green-600 hover:to-emerald-700 transition-all duration-200 transform hover:scale-105 flex items-center space-x-2 relative"
                    >
                      {loading ? (
                      ...
                      <span>{loading ? "Marking..." : "Mark Complete"}</span>
                    </button>
                  ) : (
