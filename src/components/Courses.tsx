    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-2 transition-colors duration-300">All Courses</h1>
          <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">Discover and learn essential life skills through our comprehensive course catalog</p>
        </div>
        ...
        {filteredCourses.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2 transition-colors duration-300">No courses found</h3>
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">Try adjusting your search or filters to find more courses</p>
          </div>
        )}
      </div>
    </div>
