      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b dark:border-gray-700 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-4 py-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200 transition-colors duration-300">
                {course.title}
              </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-colors duration-300">
              ...
              <div className="p-6">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl transition-colors duration-300">
                  <h3 className="font-semibold text-lg mb-3 text-purple-800 dark:text-purple-300 transition-colors duration-300">
                    What You'll Learn
                  </h3>
                  <ul className="space-y-2 text-gray-700 dark:text-gray-300 transition-colors duration-300">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Master essential life skills not taught in school
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-300">
              <h3 className="text-xl font-bold mb-6 text-gray-800 dark:text-gray-200 transition-colors duration-300">
                Course Modules
              </h3>
              <div className="space-y-4">
                {course.modules.map((module, index) => {
                  ...
                  const isUnlocked =
                    index === 0 || course.modules[index - 1].isCompleted;
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div
                            className={`p-3 rounded-full transition-colors duration-300 ${getModuleColor(
                              module.type
                            )}`}
                          >
          ...
          <div className="space-y-6">
            ...
            {/* Progress Card */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-300">
              <h3 className="font-semibold text-lg mb-4 text-gray-800 dark:text-gray-200 transition-colors duration-300">
                Your Progress
              </h3>
              <div className="space-y-4">
                <div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors duration-300">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg transition-colors duration-300">
                  ...
                  <div>
                    <div className="font-semibold text-sm text-gray-800 dark:text-gray-200 transition-colors duration-300">
                      First Steps
                    </div>
