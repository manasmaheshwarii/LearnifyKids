...
export const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  const getCategoryImage = (categoryId: string) => {
    ...
    return (
      imageMap[categoryId as keyof typeof imageMap] ||
      imageMap["public-speaking"]
    );
  };
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-200 transform group-hover:scale-105"
          >
            Explore
          </button>
        </div>
